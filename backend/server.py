...
SAMPLE_OPPORTUNITIES = [
    {
        ...
        "tenure_years": 5,
        "funded_pct": 78,
        "tags": ["Pre-Leased", "A-Grade", "MNC Tenant"],
        "highlight": "9-year lock-in with marquee global tenant in India's premier office market.",
    },
    {
        "id": "opp-orr-prism",
    ...
    },
    {
        ...
        "funded_pct": 91,
        "tags": ["Pre-Leased", "NCR"],
        "highlight": "100% leased to Big-4 consulting; 15% escalation every 3 years.",
    },
    {
        "id": "opp-mind-hyd",
        "name": "Mindscape Towers",
        "location": "Hitec City, Hyderabad",
        "asset_type": "A-Grade Office",
        "tenant": "Global Bank GCC",
        ...
        "tenure_years": 5,
        "funded_pct": 42,
        "tags": ["GCC Tenant", "High Yield"],
        "highlight": "Anchor tenant is a top-10 global bank GCC; Hyderabad's fastest growing micro-market.",
    },
    {
        "id": "opp-pune-axis",
        "name": "Axis Commercial Hub",
        "location": "Kharadi, Pune",
        "asset_type": "Logistics + Office",
        "tenant": "Pharma Major",
        ...
        "tenure_years": 4,
        "funded_pct": 55,
        "tags": ["Logistics", "Long Lease"],
        "highlight": "Hybrid logistics-office asset leased to a top Indian pharma manufacturer.",
    },
    {
        "id": "opp-chen-marina",
        ...
        "highlight": "Lowest minimum ticket size; ideal for first-time fractional investors.",
    },
    {
        "id": "opp-bom-meridian",
        "name": "Meridian Lower Parel",
        ...
        "tenure_years": 6,
        "funded_pct": 88,
        "tags": ["Marquee", "Mumbai CBD"],
        "highlight": "Trophy asset on India's most expensive office street; 10-year iron-clad lease.",
    },
    {
        ...
        "tenure_years": 6,
        "funded_pct": 18,
        "tags": ["Leverage Product", "Coming Soon"],
        "highlight": "Property Verse's flagship leverage-backed fractional pool — 1.6x effective yield amplification.",
    },
]
...
async def on_startup():
    ...
    if not existing_test:
        await db.users.insert_one({
            ...
            "role": "investor",
            "created_at": datetime.now(timezone.utc).isoformat(),
            "watchlist": ["opp-bkc-skyline", "opp-orr-prism"],
        })
